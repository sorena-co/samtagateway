package ir.samta.gateway.config.timezone;

import ir.samta.gateway.SamtagatewayApp;
import ir.samta.gateway.config.SecurityBeanOverrideConfiguration;
import ir.samta.gateway.repository.timezone.DateTimeWrapper;
import ir.samta.gateway.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, SamtagatewayApp.class})
